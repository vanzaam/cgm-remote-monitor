...
function init (client, serverSettings, $) {
  ...
  function loadForm () {
    ...
    var showSnoozeBar = storage.get('showSnoozeBar');
    $('#showsnoozebar-browser').prop('checked', showSnoozeBar !== false && showSnoozeBar !== 'false');
  ...
  function wireForm () {
    ...
    $('#save').click(function(event) {
      ...
      storeInBrowser({
        ...
        , showSnoozeBar: $('#showsnoozebar-browser').prop('checked')
