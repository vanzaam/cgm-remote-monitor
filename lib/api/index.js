...
function create (env, ctx) {
 ...
 // Start setting up routes
  ...
  // Site settings (stored in MongoDB)
  app.use('/', require('./settings-api')(app, wares, ctx, env));

  // Web Push subscription API
  app.use('/', require('./push-api')(app, wares, ctx));

  // Data simulator API
  app.use('/', require('./simulator-api')(app, wares, ctx));
