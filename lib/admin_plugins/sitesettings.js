    ...
    bridge: {
      ...
      fields: [
        ...
        { key: 'password', label: 'Dexcom Password', type: 'password', default: '' },
        {
          ...
          type: 'select',
          options: [
            { value: '', label: 'Default (US host; BRIDGE_SERVER env if set)' },
            { value: 'US', label: 'US (share2.dexcom.com)' },
            { value: 'EU', label: 'EU (shareous1.dexcom.com)' }
          ],
          default: '',
          hint: 'Empty = US + optional BRIDGE_SERVER on the host.'
        },
