          ...
          webpush.sendNotification(pushSub, payloadStr)
            ...
            .catch(function (sendErr) {
              ...
              if (code === 410) {
                ...
                // 400 = bad request, possibly VAPID issue — DON'T remove, log details
                console.warn('Web Push: rejected by push service (400) for', id,
                  '— check VAPID_EMAIL env var. Error:', sendErr.body || sendErr.message);
