...
// Fields that must NEVER be returned via API
var HIDDEN_FIELDS = ['auth.API_SECRET', 'integrations.loop.apnsKey'];

// Fields that only admin can see
var ADMIN_ONLY_FIELDS = ['auth', 'integrations'];
