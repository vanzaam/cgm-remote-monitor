...
const init = function init () {
  ...
  // Fallback: if JWT key file not found, generate a random key for this session
  if (!secrets[jwtKey]) {
    secrets[jwtKey] = crypto.randomBytes(32).toString('hex');
    console.log('JWT key file not found, generated random key for this session');
  }
